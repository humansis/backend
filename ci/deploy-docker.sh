...
# start main app (php-fpm, nginx, phpmyadmin)
start_app="cd /opt/humansis && sudo docker-compose pull php nginx && sudo docker-compose up -d php nginx phpmyadmin"
...
if [[ -f docker-compose.consumer.yml ]]; then
  ...
  start_consumers="cd /opt/humansis && sudo docker-compose up -d import_consumer smartcard_purchase_consumer smartcard_deposit_consumer"
