...
class CountrySpecific extends Criteria implements ExportableInterface
{
     ...
     *
     * @param \Entity\CountrySpecificAnswer $countrySpecificAnswer
     *
     * @return CountrySpecific
     */
    public function addCountrySpecificAnswer(\Entity\CountrySpecificAnswer $countrySpecificAnswer)
    {
     ...
     */
    public function removeCountrySpecificAnswer(\Entity\CountrySpecificAnswer $countrySpecificAnswer)
    {
