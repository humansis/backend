...
class FileMapper implements MapperInterface
{
    ...
    {
        return $object instanceof File && isset($context[self::NEW_API]) && true === $context[self::NEW_API];
    }
    ...
    public function populate(object $object)
    {
        ...
        throw new \InvalidArgumentException('Invalid argument. It should be instance of '.File::class.', '.get_class($object).' given.');
    }
