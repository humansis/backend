...
namespace NewApiBundle\DataFixtures\Beneficiaries;

use NewApiBundle\Entity\Beneficiary;
use NewApiBundle\Entity\Community;
use NewApiBundle\Entity\Household;
use NewApiBundle\Entity\Institution;
use NewApiBundle\DataFixtures\AssistanceFixtures;
use NewApiBundle\DataFixtures\BeneficiaryTestFixtures;
use NewApiBundle\DataFixtures\ProjectFixtures;
