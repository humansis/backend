...
class AssistanceBeneficiaryCommodityRepository extends EntityRepository
{
    public function findForSmartcardByAssistanceBeneficiary(Assistance $assistance, Beneficiary $beneficiary): ?AssistanceBeneficiaryCommodity
    {
