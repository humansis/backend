...
final class ScoringRuleCalculationOptionsEnum
{
    ...
    public const SUPPORTED = [
        ...
        ScoringRulesCalculationsEnum::HH_HEAD_VULNERABILITY => [
        ...
        ScoringRulesCalculationsEnum::HH_MEMBERS_VULNERABILITY => [
            self::CHRONICALLY_ILL,
            self::INFANT,
            self::ELDERLY,
            self::PREGNANT_LACTATING_FEMALE,
        ...
        ScoringRulesCalculationsEnum::COMPLEX_DEPENDENCY_RATIO => [
        ...
        ScoringRulesCalculationsEnum::CSI => [
            self::CSI_0_20,
            self::CSI_20_30,
            self::CSI_30_40,
            self::CSI_40_MORE,
        ...
        ScoringRulesCalculationsEnum::FCS => [
            self::CONSUMPTION_POOR,
            self::CONSUMPTION_BORDERLINE,
            self::CONSUMPTION_ACCEPTABLE,
        ],

        ScoringRulesCalculationsEnum::HH_HEAD_GENDER => [
            self::GENDER_FEMALE,
            self::GENDER_MALE,
        ],

        ScoringRulesCalculationsEnum::DEBT => [
            self::DEBT_LEVEL_1,
            self::DEBT_LEVEL_2,
            self::DEBT_LEVEL_3,
            self::DEBT_LEVEL_4,
        ...
        ScoringRulesCalculationsEnum::ASSISTANCE_PROVIDED => [
