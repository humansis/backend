...
use NewApiBundle\Component\Import\Integrity\ImportParser;
...
class UploadImportService
{
    ...
    public function __construct(EntityManagerInterface $em, string $uploadDirectory, FileValidator $importFileValidator)
    {
    ...
    public function load(ImportFile $importFile): ImportFile
    {
        ...
        try {
            foreach ($list as $hhData) {
                ...
                //
                // $queue = new Queue($importFile->getImport(), $importFile, $hhData);
