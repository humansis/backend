...
class AssistanceBankReportTransformData
{
     ...
     */
    public function transformData(array $distributions): array
    {
        $exportableTable = [];
        ...
        foreach ($distributions as $distribution) {
            $exportableTable [] = [
                ...
                $this->translator->trans(
                    'Recipient’s patronymic (Local parent’s name)'
                ) => $distribution['localParentsName'],
                ...
                $this->translator->trans('Remittance amount') => (float) $distribution['amountToDistribute'],
