...
class UserFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private $defaultCountries = ["KHM", "SYR", "UKR", "ETH", "MNG"];
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach ($this->allCountryUsers as $index => $userData) {
            $this->makeUser($manager, $userData, $this->defaultCountries);
        }
     ...
     * @return void
     */
    private function makeUser(ObjectManager $manager, $userData, array $countries): void
    {
