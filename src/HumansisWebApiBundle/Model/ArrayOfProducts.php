...
class ArrayOfProducts 
{
    ...
    /**
     * @var Humansis\WebApi\Model\Product[]|null
     * @SerializedName("data")
     * @Assert\All({
     *   @Assert\Type("Humansis\WebApi\Model\Product")
     * })
     * @Type("array<Humansis\WebApi\Model\Product>")
     */
    protected $data;
     ...
     * Gets data.
     *
     * @return Humansis\WebApi\Model\Product[]|null
     */
     ...
     * Sets data.
     *
     * @param Humansis\WebApi\Model\Product[]|null $data
     *
     * @return $this
     */
