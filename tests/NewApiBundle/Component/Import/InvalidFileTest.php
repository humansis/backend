...
class InvalidFileTest extends KernelTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$importInvalidFileService = $kernel->getContainer()->get(InvalidFileService::class);
    ...
    public function testCreateInvalidFileAndImportAgain()
    {
        ...
        $importedFile = self::$entityManager->getRepository(File::class)
            ->findOneBy([
