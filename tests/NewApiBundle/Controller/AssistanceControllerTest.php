...
class AssistanceControllerTest extends BMSServiceTestCase
{
    ...
    public function testGetItem()
    {
        ...
        $assistance = $this->getContainer()->get('doctrine')->getRepository(Assistance::class)->findBy([])[0];
    ...
    public function testCreateDistribution()
    {
        ...
        $modalityType = $this->getContainer()->get('doctrine')->getRepository(ModalityType::class)->findBy(['name' => 'Cash'])[0];
    ...
    public function testCreateCommunityActivity()
    {
        ...
        $community = $this->getContainer()->get('doctrine')->getRepository(Community::class)->findBy([])[0];
