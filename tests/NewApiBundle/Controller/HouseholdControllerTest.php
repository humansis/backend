...
class HouseholdControllerTest extends BMSServiceTestCase
{
    ...
    public function testCreate()
    {
        ...
        $vulnerabilityCriterion = $this->getContainer()->get('doctrine')->getRepository(VulnerabilityCriterion::class)->findBy([])[0];
    ...
    public function testUpdate(int $id)
    {
        ...
        $vulnerabilityCriterion = $this->getContainer()->get('doctrine')->getRepository(VulnerabilityCriterion::class)->findBy([])[0];
        $location = $this->getContainer()->get('doctrine')->getRepository(Location::class)->findBy([])[0];
        $camp = $this->getContainer()->get('doctrine')->getRepository(Camp::class)->findBy([])[0];
