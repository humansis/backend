...
class UploadImportServiceTest extends KernelTestCase
{
    ...
    {
        $project = $this->entityManager->getRepository(\Entity\Project::class)->findBy(['archived' => false], ['id' => 'asc'], 1)[0];
        $user = $this->entityManager->getRepository(\Entity\User::class)->findBy([], ['id' => 'asc'], 1)[0];
        ...
        $queue = $this->entityManager->getRepository(\Entity\ImportQueue::class)->findBy(['import' => $import], ['id' => 'asc']);
