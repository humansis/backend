 ...
 */
final class Version20180702094757 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reporting_indicator (id INT AUTO_INCREMENT NOT NULL, reference VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, filters LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', graphique VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_158D0C7177153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
