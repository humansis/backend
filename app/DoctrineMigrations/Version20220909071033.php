 ...
 */
final class Version20220909071033 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        $this->addSql('ALTER TABLE location CHANGE COLUMN countryISO3 iso3 VARCHAR(3) NOT NULL');
        $this->addSql('ALTER TABLE scoring_blueprint MODIFY COLUMN iso3 VARCHAR(3) NOT NULL');
