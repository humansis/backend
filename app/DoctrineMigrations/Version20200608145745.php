...
final class Version20200608145745 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE smartcard_record (id INT AUTO_INCREMENT NOT NULL, smartcard_id INT DEFAULT NULL, product_id INT DEFAULT NULL, value NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, quantity NUMERIC(10, 2) DEFAULT NULL, INDEX IDX_CA9F1B434584665A (product_id), INDEX IDX_CA9F1B43AC8B107D (smartcard_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
