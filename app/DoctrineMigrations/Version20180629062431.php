 ...
 */
final class Version20180629062431 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reporting_country (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, indicator_id INT DEFAULT NULL, value_id INT NOT NULL, INDEX IDX_8522EACEF92F3E70 (country_id), INDEX IDX_8522EACE4402854A (indicator_id), INDEX IDX_8522EACEF920BBA2 (value_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reporting_country ADD CONSTRAINT FK_8522EACEF92F3E70 FOREIGN KEY (country_id) REFERENCES location (id)');
