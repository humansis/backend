...
final class Version20210531112503 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE import_queue CHANGE state state ENUM(\'New\', \'Valid\', \'Invalid\', \'Suspicious\', \'To Create\', \'To Update\', \'To Link\', \'To Ignore\') NOT NULL COMMENT \'(DC2Type:enum_import_queue_state)\''
        );
    }
}
