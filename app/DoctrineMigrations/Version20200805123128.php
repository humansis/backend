...
final class Version20200805123128 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `household_project` DROP FOREIGN KEY `FK_42473AC0E79FF843`; ALTER TABLE `household_project` ADD CONSTRAINT `FK_42473AC0E79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;');
        $this->addSql('ALTER TABLE `country_specific_answer` DROP FOREIGN KEY `FK_4680BB30E79FF843`; ALTER TABLE `country_specific_answer` ADD CONSTRAINT `FK_4680BB30E79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;');
        $this->addSql('ALTER TABLE `household_location` DROP FOREIGN KEY `FK_822570EEE79FF843`; ALTER TABLE `household_location` ADD CONSTRAINT `FK_822570EEE79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;');
        $this->addSql('ALTER TABLE `beneficiary` DROP FOREIGN KEY `FK_7ABF446AE79FF843`; ALTER TABLE `beneficiary` ADD CONSTRAINT `FK_7ABF446AE79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;');
        $this->addSql('ALTER TABLE `household_activity` DROP FOREIGN KEY `FK_4A4E9A65E79FF843`; ALTER TABLE `household_activity` ADD CONSTRAINT `FK_4A4E9A65E79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE; ');
        ...
        $this->addSql('ALTER TABLE `household_activity` DROP FOREIGN KEY `FK_4A4E9A65E79FF843`; ALTER TABLE `household_activity` ADD CONSTRAINT `FK_4A4E9A65E79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ');
        $this->addSql('ALTER TABLE `household_location` DROP FOREIGN KEY `FK_822570EEE79FF843`; ALTER TABLE `household_location` ADD CONSTRAINT `FK_822570EEE79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ');
        $this->addSql('ALTER TABLE `household_project` DROP FOREIGN KEY `FK_42473AC0E79FF843`; ALTER TABLE `household_project` ADD CONSTRAINT `FK_42473AC0E79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT; ');
        $this->addSql('ALTER TABLE `country_specific_answer` DROP FOREIGN KEY `FK_4680BB30E79FF843`; ALTER TABLE `country_specific_answer` ADD CONSTRAINT `FK_4680BB30E79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ');
        $this->addSql('ALTER TABLE `beneficiary` DROP FOREIGN KEY `FK_7ABF446AE79FF843`; ALTER TABLE `beneficiary` ADD CONSTRAINT `FK_7ABF446AE79FF843` FOREIGN KEY (`household_id`) REFERENCES `household`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ');


        // free FK to BNF table (set to CASCADE)
        $this->addSql('ALTER TABLE `beneficiary_vulnerability_criterion` DROP FOREIGN KEY `FK_566B5C7ECCAAFA0`; ALTER TABLE `beneficiary_vulnerability_criterion` ADD CONSTRAINT `FK_566B5C7ECCAAFA0` FOREIGN KEY (`beneficiary_id`) REFERENCES `beneficiary`(`id`) ON DELETE CASCADE ON UPDATE CASCADE; ');
        $this->addSql('ALTER TABLE `distribution_beneficiary` DROP FOREIGN KEY `FK_EA141F30ECCAAFA0`; ALTER TABLE `distribution_beneficiary` ADD CONSTRAINT `FK_EA141F30ECCAAFA0` FOREIGN KEY (`beneficiary_id`) REFERENCES `beneficiary`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE; ');
        $this->addSql('ALTER TABLE `smartcard` DROP FOREIGN KEY `FK_34E0B48FECCAAFA0`; ALTER TABLE `smartcard` ADD CONSTRAINT `FK_34E0B48FECCAAFA0` FOREIGN KEY (`beneficiary_id`) REFERENCES `beneficiary`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE; ');
        // prevent ids collision
        ...
        $this->addSql('ALTER TABLE `smartcard` DROP FOREIGN KEY `FK_34E0B48FECCAAFA0`; ALTER TABLE `smartcard` ADD CONSTRAINT `FK_34E0B48FECCAAFA0` FOREIGN KEY (`beneficiary_id`) REFERENCES `beneficiary`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ');
        $this->addSql('ALTER TABLE `distribution_beneficiary` DROP FOREIGN KEY `FK_EA141F30ECCAAFA0`; ALTER TABLE `distribution_beneficiary` ADD CONSTRAINT `FK_EA141F30ECCAAFA0` FOREIGN KEY (`beneficiary_id`) REFERENCES `beneficiary`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ');
        $this->addSql('ALTER TABLE `beneficiary_vulnerability_criterion` DROP FOREIGN KEY `FK_566B5C7ECCAAFA0`; ALTER TABLE `beneficiary_vulnerability_criterion` ADD CONSTRAINT `FK_566B5C7ECCAAFA0` FOREIGN KEY (`beneficiary_id`) REFERENCES `beneficiary`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT; ');
