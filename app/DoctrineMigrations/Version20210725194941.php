...
final class Version20210725194941 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("CREATE TABLE product_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type enum('Food','Non-food','Cashback') NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB");
