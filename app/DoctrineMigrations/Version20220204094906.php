...
final class Version20220204094906 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE import_beneficiary CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE created_by_id created_by_user_id INT DEFAULT NULL'
        );
        ...
        $this->addSql(
            'ALTER TABLE import_invalid_file CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE invalid_queue_count invalid_queue_count INT NOT NULL'
        );
    }
