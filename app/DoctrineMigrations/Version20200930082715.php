...
final class Version20200930082715 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reporting_distribution DROP FOREIGN KEY FK_EC84C5186EB6DDB5');
        $this->addSql('CREATE TABLE distribution_data (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, project_id INT DEFAULT NULL, name VARCHAR(45) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, UpdatedOn DATETIME NOT NULL, date_distribution DATE NOT NULL, archived TINYINT(1) DEFAULT \'0\' NOT NULL, validated TINYINT(1) DEFAULT \'0\' NOT NULL, target_type INT DEFAULT NULL, completed TINYINT(1) DEFAULT \'0\' NOT NULL, assistance_type ENUM(\'activity\', \'distribution\') CHARACTER SET utf8 DEFAULT \'distribution\' NOT NULL COLLATE `utf8_unicode_ci` COMMENT \'(DC2Type:assistance_type_enum)\', INDEX IDX_A54E7FD7166D1F9C (project_id), INDEX IDX_A54E7FD764D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
