 ...
 */
final class Version20180925130654 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE household (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, address_street VARCHAR(255) NOT NULL, address_number VARCHAR(255) NOT NULL, address_postcode VARCHAR(255) NOT NULL, livelihood INT DEFAULT NULL, notes VARCHAR(255) DEFAULT NULL, latitude VARCHAR(45) DEFAULT NULL, longitude VARCHAR(45) DEFAULT NULL, archived TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_54C32FC064D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP FOREIGN KEY FK_723705D1F45FC34E');
