 ...
 */
final class Version20181001071348 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE beneficiary (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, household_id INT DEFAULT NULL, givenName VARCHAR(255) NOT NULL, familyName VARCHAR(255) NOT NULL, gender SMALLINT NOT NULL, status TINYINT(1) NOT NULL, dateOfBirth DATE NOT NULL, updated_on DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_7ABF446ACCFA12B8 (profile_id), INDEX IDX_7ABF446AE79FF843 (household_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, distribution_beneficiary_id INT DEFAULT NULL, transaction_id VARCHAR(45) NOT NULL, amount_sent VARCHAR(255) NOT NULL, date_sent DATETIME NOT NULL, transaction_status SMALLINT NOT NULL, message VARCHAR(255) DEFAULT NULL, money_received TINYINT(1) NOT NULL, pickup_date DATETIME DEFAULT NULL, updated_on DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_723705D195AAFAA9 (distribution_beneficiary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
