...
final class Version20220204104704 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE import_beneficiary_duplicity (member_index INT NOT NULL, queue_id INT NOT NULL, beneficiary_id INT NOT NULL, reasons LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', differences LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_CD6A7AF7477B5BAE (queue_id), INDEX IDX_CD6A7AF7ECCAAFA0 (beneficiary_id), PRIMARY KEY(queue_id, member_index, beneficiary_id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB'
        );
