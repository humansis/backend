...
final class Version20220210131422 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE import_project (import_id INT NOT NULL, project_id INT NOT NULL, INDEX IDX_3CA37902B6A263D9 (import_id), INDEX IDX_3CA37902166D1F9C (project_id), PRIMARY KEY(import_id, project_id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
