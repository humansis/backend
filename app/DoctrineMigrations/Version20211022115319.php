...
final class Version20211022115319 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE synchronization_batch (id INT AUTO_INCREMENT NOT NULL, created_by_user_id INT DEFAULT NULL, validation_type ENUM(\'Deposit\', \'Purchase\') NOT NULL COMMENT \'(DC2Type:enum_synchronization_batch_validation_type)\', state ENUM(\'Uploaded\', \'Correct\', \'Errors\', \'Archived\') NOT NULL COMMENT \'(DC2Type:enum_synchronization_batch_state)\', request_data JSON NOT NULL, violations JSON DEFAULT NULL, validated_at DATETIME DEFAULT NULL, source ENUM(\'Web\', \'Vendor\', \'User\', \'CLI\') DEFAULT NULL COMMENT \'(DC2Type:enum_source_type)\', created_at DATETIME DEFAULT NULL, INDEX IDX_8346B8467D182D95 (created_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
