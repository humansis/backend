...
class Version20220916142516 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE commodity ADD modality_type ENUM(\'Mobile Money\', \'Cash\', \'Smartcard\', \'QR Code Voucher\', \'Paper Voucher\', \'Food Rations\', \'Ready to Eat Rations\', \'Bread\', \'Agricultural Kit\', \'WASH Kit\', \'Shelter tool kit\', \'Hygiene kit\', \'Dignity kit\', \'NFI Kit\', \'Winterization Kit\', \'Activity item\', \'Loan\', \'Business Grant\') DEFAULT NULL COMMENT \'(DC2Type:enum_modality_type)\', DROP modality_type_id'
        );
