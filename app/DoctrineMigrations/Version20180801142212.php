 ...
 */
final class Version20180801142212 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE selection_criteria (id INT AUTO_INCREMENT NOT NULL, distribution_data_id INT DEFAULT NULL, table_string VARCHAR(255) NOT NULL, kind_beneficiary VARCHAR(255) DEFAULT NULL, field_string VARCHAR(255) DEFAULT NULL, field_id INT DEFAULT NULL, condition_string VARCHAR(255) DEFAULT NULL, value_string VARCHAR(255) DEFAULT NULL, INDEX IDX_61BAEEC9D744EF8E (distribution_data_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
