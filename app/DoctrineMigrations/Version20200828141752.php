 ...
 */
final class Version20200828141752 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE distribution_data ADD assistance_type ENUM(\'activity\', \'distribution\') NOT NULL DEFAULT \'distribution\' COMMENT \'(DC2Type:enum_assistance_type)\'');
