 ...
 */
final class Version20190118141140 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE booklet (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, number_vouchers INT NOT NULL, individual_value INT NOT NULL, currency VARCHAR(255) NOT NULL, status INT DEFAULT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_818DB72077153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voucher (id INT AUTO_INCREMENT NOT NULL, booklet_id INT NOT NULL, vendor_id INT DEFAULT NULL, used TINYINT(1) NOT NULL, code VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1392A5D877153098 (code), INDEX IDX_1392A5D8668144B3 (booklet_id), INDEX IDX_1392A5D8F603EE73 (vendor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
